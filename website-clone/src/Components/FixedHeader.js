...
import { faUser, faBullhorn, faMagnifyingGlass, faAngleDown } from  '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="headerOuter">
      <div className="headerContainer">
        <div className='logoWrapper'><img src={logo} alt="redditlogo" className='logo'/></div>
        ...
        <div className='buttonGroup'>
          ...
          <div><button className='faUser'><FontAwesomeIcon icon={faUser}></FontAwesomeIcon><FontAwesomeIcon icon={faAngleDown}></FontAwesomeIcon></button></div>
          </div>
          </div>
    </div>
  )
